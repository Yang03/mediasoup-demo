...
module.exports =
{
	...
	https  :
	{
		...
		tls        :
		{
			cert: `${__dirname}/certs/2798725_meeting.valley.ren.pem`,
			key: `${__dirname}/certs/2798725_meeting.valley.ren.key`
		}
	},
	// mediasoup settings.
	mediasoup :
	{
		...
		webRtcTransportOptions :
		{
			listenIps :
			[
				{ ip: '127.0.0.1', announcedIp: '112.49.23.113' }
			],
		...
		{
			listenIp           : { ip: '127.0.0.1', announcedIp: '112.49.23.113' },
			maxSctpMessageSize : 262144
		}
	}
};
